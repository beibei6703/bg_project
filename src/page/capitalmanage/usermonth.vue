<template>
  ...
  <div class="tabs-detail">
    ...
    <el-table :data="list" style="width: 100%">
      <el-table-column fixed prop="value.days" label="日期" width="150" align="center" ref="tabs">
      ...
      methods:{
        getMonthexcel(){
          if(!this.value2==''){
            ...
            window.location.href = this.baseURL +'admin/bill/monthfile?date='+date+'&token='+token+'&tab=1' ;
          }else{
            this.$message({
              showClose: true,
              message: '请选择时间',
        ...
        getmonthSucc(res){
          ...
          if(data.status == 1 && data.info){
            ...
            // this.total = this.total.map((item,index) =>{
